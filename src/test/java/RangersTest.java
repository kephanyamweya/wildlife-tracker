...
public class RangersTest {
    ...
    public void emptyFieldsAreNotSaved() {
        Rangers ranger=new Rangers("","","0703874756");
        try{
            ranger.save();
            assertTrue(Rangers.all().get(0).equals(ranger));
    ...
    public void findById() {
        Rangers ranger= setUpNewRanger();
        Rangers otherRanger=new Rangers("Ken","2","0708254563");
        ranger.save();
        otherRanger.save();
    ...
    public void entryIsUpdatedCorrectly() {
        ...
        ranger.save();
        try {
            ranger.update(ranger.getId(),"Justine","0758605603");
            Rangers foundRanger=Rangers.find(ranger.getId());
    ...
    public void entriesAreDeleted() {
        Rangers ranger= setUpNewRanger();
        Rangers otherRanger=new Rangers("Ken","2","0708254653");
        ranger.save();
        otherRanger.save();
        ranger.delete();
    ...
    private Rangers setUpNewRanger() {
        return new Rangers("Myrrh","1","07564378");
    }
