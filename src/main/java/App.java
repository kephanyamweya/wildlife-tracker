...
public class App {
    ...
    public static void main(String[] args) {
        ...
        post("/create/ranger/new", App::handle,new HandlebarsTemplateEngine());
        ...
        post("/create/animal/new",(request, response) -> {
            ...
            if(type.equals(EndangeredAnimals.ANIMAL_TYPE)){
                ...
                endangered.save();
                model.put("name",name);
                model.put("EndangeredAnimals.Animal_TYPE",EndangeredAnimals.ANIMAL_TYPE);
                ...
                animal.save();
                model.put("name", name);
                model.put("Animals.ANIMAL_TYPE",Animals.ANIMAL_TYPE);
            }
    ...
    private static ModelAndView handle(Request request, Response response) {
        ...
        Rangers newRangers = new Rangers(name, badge_number, phone_number);
        newRangers.save();
        return new ModelAndView(model, "ranger-view.hbs");
